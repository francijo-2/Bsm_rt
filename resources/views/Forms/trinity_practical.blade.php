...
<form method ="post" action = "{{ route('enter_trinity_practical', ['discipline' => $discipline, 'student' =>  $student, 'teacher' => $teacher]) }}">
{{ csrf_field() }}
<table class="table table-bordered table-hover table-condensed">
<tr style="background-color: black; color: white; text-align: center; font-size: 16px">
<td colspan ="2"; style="text-align:center";><b>Trinity Practicals</b></td></tr>
...
<td colspan = "4" style ="text-align : center"><input type="submit" name="trinity_practical_add_to_exams" value="Add to Exams" /></td></tr>
