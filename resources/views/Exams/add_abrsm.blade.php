...
<td colspan ="4"; style="text-align:center";><b>Add a ABRSM Exam
</b></td></tr>
<td><b>Examination:</b></td>
<td height = "30"><select  class="form-control"  name="abrsm"><option value="2">ABRSM</option>
</tr><tr>
...
<tr>
<td colspan="3"; style="text-align:center;"><button class="form-control btn btn-primary" type="submit" name="submit_ABRSM_exam"/>Add Exam</button></td>
</tr>
