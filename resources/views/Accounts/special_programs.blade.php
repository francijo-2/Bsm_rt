...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav pull-left">
      <li><a href="{{ route('new_admission') }}">Graded Coursed</a></li>
       <li class="active"><a href="{{ route('short_term_program') }}">Short Term Programs</a></li>
...
<td colspan ="4"><b>New Admission Special Programs</b></td></tr>
