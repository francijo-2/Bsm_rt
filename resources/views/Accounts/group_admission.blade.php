...
<form action="/Accounts/Accounts/New_admission/EnterStudentGroup" method="post">
{{ csrf_field() }}			
...
<tr>
      ...
      <td><input class="form-control" type="text" name="email_address1" size="15" id="the_email" readonly value="{{ $email_address1 }}"/><input type="hidden" name="user" value="{{ Auth::user()->id }}" /></td>
</tr> 
